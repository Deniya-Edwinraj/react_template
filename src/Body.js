    ...
    <div className="row gx-0">
      ...
      <div className="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
        <div className="content">
          ...
          <div className="text-center text-lg-start">
            <a href="ani" className="btn-read-more d-inline-flex align-items-center justify-content-center align-self-center">
              <span>Read More</span>
              <i className="bi bi-arrow-right"></i>
            </a>
          </div>
  ...
  <div className="container" data-aos="fade-up">
    ...
    <div className="row">
      ...
      <div className="col-lg-4" data-aos="fade-up" data-aos-delay="200">
        <div className="box">
          <img src={require("./assets/img/values-1.png")} className="img-fluid" alt=""/>
      ...
      <div className="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
        <div className="box">
          <img src={require("./assets/img/values-2.png")} className="img-fluid" alt=""/>
      ...
      <div className="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
        <div className="box">
          <img src={require("./assets/img/values-3.png")} className="img-fluid" alt=""/>
...
<section id="features" className="features">
  ...
  <div className="container" data-aos="fade-up">
    ...
    <div className="row feture-tabs" data-aos="fade-up">
      ...
      <div className="col-lg-6">
        <img src={require("./assets/img/features-2.png")} className="img-fluid" alt=""/>
      </div>
    ...
    <div className="row feature-icons" data-aos="fade-up">
      ...
      <div className="row">
        ...
        <div className="col-xl-4 text-center" data-aos="fade-right" data-aos-delay="100">
          <img src={require("./assets/img/features-3.png")} className="img-fluid p-4" alt=""/>
        </div>
    ...
    <div className="row gy-4">
      ...
      <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
        <div className="service-box blue">
          ...
          <a href="readmore" className="read-more"><span>Read More</span> <i className="bi bi-arrow-right"></i></a>
        </div>
      </div>
    ...
    <div className="row gy-4" data-aos="fade-left">
      ...
      <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
        <div className="box">
          ...
          <img src={require("./assets/img/pricing-free.png")} className="img-fluid" alt=""/>
          <ul>
            <li>Aida dere</li>
          ...
          <a href="buy" className="btn-buy">Buy Now</a>
        </div>
      </div>
      ...
      <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
        <div className="box">
          ...
          <img src={require("./assets/img/pricing-starter.png")} className="img-fluid" alt=""/>
          <ul>
            <li>Aida dere</li>
            <li>Nec feugiat nisl</li>
            <li>Nulla at volutpat dola</li>
      ...
      <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
        <div className="box">
          ...
          <img src={require("./assets/img/pricing-business.png")} className="img-fluid" alt=""/>
          <ul>
            <li>Aida dere</li>
            <li>Nec feugiat nisl</li>
            <li>Nulla at volutpat dola</li>
      ...
      <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
        <div className="box">
          ...
          <img src={require("./assets/img/pricing-ultimate.png")} className="img-fluid" alt=""/>
          <ul>
            <li>Aida dere</li>
            <li>Nec feugiat nisl</li>
            <li>Nulla at volutpat dola</li>
        ...
        <div className="member">
          <div className="member-img">
            ...
            <div className="social">
              ...
              <a href="facebook"><i className="bi bi-facebook"></i></a>
              <a href="instagram"><i className="bi bi-instagram"></i></a>
              <a href="limkedin"><i className="bi bi-linkedin"></i></a>
            </div>
          </div>
          <div className="member-info">
            <h4>Sarah Jhonson</h4>
        ...
        <div className="member">
          <div className="member-img">
            ...
            <div className="social">
              ...
              <a href="facebook"><i className="bi bi-facebook"></i></a>
              <a href="instagram"><i className="bi bi-instagram"></i></a>
              <a href="linknedin"><i className="bi bi-linkedin"></i></a>
            </div>
          </div>
          <div className="member-info">
      ...
      <div className="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
        <div className="member">
          <div className="member-img">
            ...
            <div className="social">
              <a href="facebooktwitter"><i className="bi bi-twitter"></i></a>
              <a href="facebook"><i className="bi bi-facebook"></i></a>
              <a href="instagram"><i className="bi bi-instagram"></i></a>
              <a href="linkedin"><i className="bi bi-linkedin"></i></a>
            </div>
